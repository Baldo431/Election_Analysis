...
# Open the election results and read the file. Open the analysis file to write to.
with open(file_to_load, encoding='UTF-8') as election_data, open(file_to_save, 'w') as outfile:
